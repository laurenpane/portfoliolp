        ...
        <div className="project-grid">
          <div className="kodflix">
            ...
            <p className="kCaption">
              ...
              source, and is deployed using Heroku. This application is
              compatible with desktop and mobile. This project was built during
              the course of the Kodiri.com bootcamp, in May-June 2020.
            </p>
